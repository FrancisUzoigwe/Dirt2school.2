...
const Card = () => {
  ...
  return (
    <div className="w-auto h-[250px] relative border rounded-xl my-2 mx-1 first-letter: ">
      <div className="m-4">
        <div className="relative">
          ...
          >
            {!close ? (
              <div>
                <FaEye className="text-2xl hover:scale-110 transition-all duration-300" />
              </div>
            ) : (
              <div>
                <FaEyeSlash className="text-2xl hover:scale-110 transition-all duration-300" />
              </div>
            )}
          </div>
          <div className="text-3xl font-bold ml-3 hover:cursor-pointer text-white mt-2 flex ">
            ₦
            <span className="ml-1">
        ...
        <div
          className="text-white absolute bottom-5 left-10 flex-col flex items-center hover:cursor-pointer hover:scale-110 transition-all duration-300"
          onClick={() => {
            dispatch(cashedOut());
          }}
        >
...
const CardI = () => {
  return (
    <div className="w-auto h-[250px] border rounded-xl my-2 mx-1 first-letter: ">
      <div className="m-4">
        <div className="font-bold text-white text-3xl mt-2">Bags Brought:</div>
