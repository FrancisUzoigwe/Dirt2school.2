    ...
    <div id="company" className="w-full flex items-center justify-center">
        <div className="w-[90%] flex items-center justify-between max-sm:flex-col-reverse">
            <div className="w-[50%] max-sm:w-[100%]">
                <h2 className="text-[30px] max-sm:text-[24px] max-md:text-[26px] font-bold">Our Commitment</h2>
                <br/>
                <p className="w-[80%] max-sm:w-[100%] max-md:w-[100%]">Focused on improving the quality of life through proper efficient waste disposal, Dirt to school aim at using recycled plastic to send students to school through our service.</p>
                <br/>
                <button
